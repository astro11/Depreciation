' Program Name:     Trends Menswear Depreciation Windows Application
' Author:           Aquila Strother
' Date:             5/22/2016
' Purpose:          The Trends Menswear Inventory Windows Application determines
...
Public Class frmDepreciation
    ...
    Private Sub frmDepreciation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ' The frmDepreciation load event reads the inventory text files and
        ...
        Dim strLocationAndNameOfFile As String = "C:\Users\JetStream\Documents\Book Files\Chapter 08\inventory.txt"
    ...
    Private Sub StraightLineDepreciation(ByVal intItemId As Integer)
        ...
        ' The Loop repats for the life of the items
    ...
    Private Sub DoubleDecliningDepreciation(ByVal intItemId As Integer)
        ...
        ' The procedure MaeObjectsVisible is called to dispay the form objects
        MakeObjectsVisible()
        ' Display the item and quantity of the selected item
        ...
        For intDoublePresentYear = 1 To _intLifeOfItems
            ...
            ' Accumulates the total of depreciaiton
